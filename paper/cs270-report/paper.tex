...
\While{Any of the $A_j$ happen under the current value of $X$}
...
\While{Any clause is violated by $X$}
...
\Function{Fix}{i}
  ...
  \ForAll{$j \in [m]: j \in \Gamma(i), A_j(X)$}
    \Call{Fix}{j}
  \EndFor
\EndFunction
...
\seqn
  ...
  x \in \mathcal{B}(1, n, ||\cdot||_\infty) \\
